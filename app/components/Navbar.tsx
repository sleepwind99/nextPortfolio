...
const Navbar = () => {
  ...
  const toGit = () => {
    window.location.href = "https://github.com/sleepwind99";
  };
  return (
    <div className="z-30">
      ...
      >
        <div
          className={`fixed left-0 top-[60px] w-full bg-light shadow-lg transition-transform duration-500 ease-in-out transform ${
